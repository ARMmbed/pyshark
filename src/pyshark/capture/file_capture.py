...
class FileCapture(Capture):
    ...
    def __init__(self, input_file=None, keep_packets=True, display_filter=None, only_summaries=False, decode_as=None, tshark_path=None, override_prefs=None, tshark_arguments=None):
        """
